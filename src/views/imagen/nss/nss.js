...
const tableNSSImagen = {
    oncreate: () => {
        NSSImagen.loadNSSImagen();
        if (NSSImagen.searchField.length !== 0) {
            var table = $('#table-NSSImagen').DataTable();
            table.search(NSSImagen.searchField).draw();
        }
            ...
            m("div.col-12", [
                ...
                m("div.table-content.col-12.pd-r-0.pd-l-0.pd-b-20.", [
                    ...
                    m("div.d-flex.align-items-center.justify-content-between.mg-b-80.mg-t-10", [
                        m("h5.mg-b-0",
                            ...
                            m("span.badge.badge-primary.tx-semibold.pd-l-10.pd-r-10.mg-l-5.tx-15", {
                                    oncreate: (el) => {
                                        if (NSSImagen.idFiltro == 1) {
                                            el.dom.innerHTML = 'NSSImagen de Hoy';
                                        }
                                        if (NSSImagen.idFiltro == 2) {
                                            el.dom.innerHTML = 'NSSImagen entre Fechas';
                                        }
                                        if (NSSImagen.idFiltro == 3) {
                                            el.dom.innerHTML = 'NSSImagen de Emergencia';
                                        }
                                        if (NSSImagen.idFiltro == 4) {
                                            el.dom.innerHTML = 'NSSImagen de Hospitalización';
                                        }
                                        if (NSSImagen.idFiltro == 5) {
                                            el.dom.innerHTML = 'NSSImagen de PB';
                                        }
                                        if (NSSImagen.idFiltro == 6) {
                                            el.dom.innerHTML = 'NSSImagen de H1';
                                        }
                                        if (NSSImagen.idFiltro == 7) {
                                            el.dom.innerHTML = 'NSSImagen de H2';
                                        }
                                        if (NSSImagen.idFiltro == 8) {
                                            el.dom.innerHTML = 'NSSImagen de C2';
                                        }
                                    },
                                    onupdate: (el) => {
                                        if (NSSImagen.idFiltro == 1) {
                        ...
                        m("div.d-flex.tx-14", [
                            m('.', {
                                class: (NSSImagen.idFiltro == 1 ? 'd-none' : 'd-flex')
                            }, [
                                m("div.link-03", {
                                        title: "Desde"
                                    },
                                ...
                                m("div.link-03", {
                                    ...
                                    m("input.tx-light.pd-4[type='date'][id='desde']", {
                                        oncreate: (el) => {
                                            el.dom.value = (NSSImagen.idFiltro !== 1 ? moment(moment(NSSImagen.fechaDesde, 'DD-MM-YYYY')).format('YYYY-MM-DD') : '');
                                        },
                                        onchange: (el) => {
                                            NSSImagen.fechaDesde = moment(moment(el.target.value, 'YYYY-MM-DD')).format('DD-MM-YYYY');
                                            NSSImagen.loader = true;
                                            NSSImagen.pedidos = [];
                                            NSSImagen.fetch();
                                            m.route.set("/farmacia/NSSImagen/?idFiltro=" + NSSImagen.idFiltro + "&fechaDesde=" + NSSImagen.fechaDesde + "&fechaHasta=" + NSSImagen.fechaHasta);
                                        },
                                        style: {
                                            "border": "transparent"
                                        }
                                ...
                                m("div.link-03", {
                                    ...
                                    m("input.tx-light.pd-4[type='date'][id='hasta']", {
                                        oncreate: (el) => {
                                            el.dom.value = (NSSImagen.idFiltro !== 1 ? moment(moment(NSSImagen.fechaHasta, 'DD-MM-YYYY')).format('YYYY-MM-DD') : '');
                                        },
                                        onchange: (el) => {
                                            NSSImagen.fechaHasta = moment(moment(el.target.value, 'YYYY-MM-DD')).format('DD-MM-YYYY');
                                            NSSImagen.loader = true;
                                            NSSImagen.pedidos = [];
                                            NSSImagen.fetch();
                                            m.route.set("/farmacia/NSSImagen/?idFiltro=" + NSSImagen.idFiltro + "&fechaDesde=" + NSSImagen.fechaDesde + "&fechaHasta=" + NSSImagen.fechaHasta);
                            ...
                            m("div.dropdown.dropleft", [
                                ...
                                m(".dropdown-menu.tx-13[aria-labelledby='dropdownMenuButton']", [
                                    ...
                                    m(m.route.Link, { class: 'dropdown-item', href: "/farmacia/NSSImagen/?idFiltro=1" }, [
                                        "NSSImagen de Hoy"
                                    ]),
                                    m(m.route.Link, { class: 'dropdown-item', href: "/farmacia/NSSImagen/?idFiltro=2&fechaDesde=" + NSSImagen.fechaDesde + "&fechaHasta=" + NSSImagen.fechaHasta }, [
                                        "NSSImagen entre Fechas"
                                    ]),
                                    m(m.route.Link, { class: 'dropdown-item', href: "/farmacia/NSSImagen/?idFiltro=3&fechaDesde=" + NSSImagen.fechaDesde + "&fechaHasta=" + NSSImagen.fechaHasta }, [
                                        "NSSImagen de Emergencia"
                                    ]),
                                    m(m.route.Link, { class: 'dropdown-item', href: "/farmacia/NSSImagen/?idFiltro=4&fechaDesde=" + NSSImagen.fechaDesde + "&fechaHasta=" + NSSImagen.fechaHasta }, [
                                        "NSSImagen de Hospitalización"
                                    ]),
                                    m(m.route.Link, { class: 'dropdown-item', href: "/farmacia/NSSImagen/?idFiltro=5&fechaDesde=" + NSSImagen.fechaDesde + "&fechaHasta=" + NSSImagen.fechaHasta }, [
                                        "NSSImagen de PB"
                                    ]),
                                    m(m.route.Link, { class: 'dropdown-item', href: "/farmacia/NSSImagen/?idFiltro=6&fechaDesde=" + NSSImagen.fechaDesde + "&fechaHasta=" + NSSImagen.fechaHasta }, [
                                        "NSSImagen de H1"
                                    ]),
                                    m(m.route.Link, { class: 'dropdown-item', href: "/farmacia/NSSImagen/?idFiltro=7&fechaDesde=" + NSSImagen.fechaDesde + "&fechaHasta=" + NSSImagen.fechaHasta }, [
                                        "NSSImagen de H2"
                                    ]),
                                    m(m.route.Link, { class: 'dropdown-item', href: "/farmacia/NSSImagen/?idFiltro=8&fechaDesde=" + NSSImagen.fechaDesde + "&fechaHasta=" + NSSImagen.fechaHasta }, [
                                        "NSSImagen de C2"
                                    ]),
                    ...
                    m("div.col-sm-12.filemgr-content-header", {
                        class: (NSSImagen.idFiltro == 1 ? "mg-t-35" : "mg-t-40")
                    }, [
                        m("i[data-feather='search']"),
                        m("div.search-form",
                            m("input.form-control[type='search'][placeholder='Buscar'][id='searchField']", {

                                oninput: function(e) { NSSImagen.searchField = e.target.value; },
                                value: NSSImagen.searchField,
                            })
                        ),
                    ...
                    m("table.table.table-sm.tx-11[id='table-NSSImagen'][width='100%']"),
...
const NSSImagen = {
    ...
    loadNSSImagen: () => {
        ...
        var table = $("#table-NSSImagen").DataTable({
            ...
            drawCallback: function(settings) {
                ...
                NSSImagen.despachos = 0;
                NSSImagen.pendientes = 0;
    ...
    fetch: () => {
        ...
        if (NSSImagen.idFiltro == 1) {
            _queryString = '?idFiltro=' + NSSImagen.idFiltro;
        } else {
            _queryString = '?idFiltro=' + NSSImagen.idFiltro + '&fechaDesde=' + NSSImagen.fechaDesde + '&fechaHasta=' + NSSImagen.fechaHasta;
        }
        ...
        m.request({
            ...
            .then(function(result) {
                NSSImagen.loader = false;
                NSSImagen.pedidos = result.data;
            })
            .catch(function(e) {
                setTimeout(function() { NSSImagen.fetch(); }, 2000);
            });
    ...
    reloadData: () => {
        var table = $('#table-NSSImagen').DataTable();
        table.clear();
        table.rows.add(NSSImagen.pedidos).draw();
    },
    view: (_data) => {

        return NSSImagen.loader ? [
            m(SidebarImagen, { oncreate: SidebarImagen.setPage(35) }),
        ...
        ] : !NSSImagen.loader && NSSImagen.pedidos.length !== 0 ? [
            m(SidebarImagen, { oncreate: SidebarImagen.setPage(35) }),
            m("div.content.content-components",
                m("div.container.mg-l-0.mg-r-0", {
                    style: { "max-width": "100%" }
